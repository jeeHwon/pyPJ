...
# ======================== ver 3.05 ========================
# 201218 복기 : ver3.04 time_sleep(0.1)은 제한걸려서 폐기, 익절 라인까지 기다리다 손해

# 업데이트 내용 : 
# 1) 볼린저밴드 반전매매 종목 리스트 추가
# 2) 익절라인 조정 : 기존 5%는 너무 높다. 작게 많이 먹어보자
# 3) 손절라인 조정 : 손절라인 3%로 재조정
# 4) 기존 한번에 크게 먹고 자잘한거 매꾸자 -> 수정 자잘하게 먹고 오를때까지 기다려주자
# target : 10
# price percent : 0.098
