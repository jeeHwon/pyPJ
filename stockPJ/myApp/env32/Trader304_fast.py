...
# ======================== ver 3.04 ========================
# 201217 복기 : 상승주 초반(0905~0910) 집중매수 필요, 손절 라인 위로 올려서 빨리 털어보자
# - 매수시점 : 0906 0908 0908 0908 0909 0909 0910 0910 0911 0912 0914
# - 최고시점 : 0908 0912 0906 1257 0911 0929 0911 0910 0903 1415 0912
# =====================fast_version : time.sleep(1) -> time.sleep(0.1)
# 업데이트 내용 : 
# 1) 0905~0910 sell 함수 배제하여 최대한 매수에 집중
# 2) 손절라인 조정
# target : 10
# price percent : 0.095 => 0.098
